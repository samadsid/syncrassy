...
function upgradeCommonChaincode() {
  installChaincode ${ORG1} ${CHAINCODE_COMMON_NAME} ${CHAINCODE_VERSION}
  upgradeChaincode ${ORG1} ${CHAINCODE_COMMON_NAME} ${CHAINCODE_VERSION} ${CHAINCODE_COMMON_INIT} common \""${policy}"\"
  installChaincode ${ORG2} ${CHAINCODE_COMMON_NAME} ${CHAINCODE_VERSION}
  installChaincode ${ORG3} ${CHAINCODE_COMMON_NAME} ${CHAINCODE_VERSION}
}
